...
SUPPORTED_EXTENSIONS = {
    ...
    ".txt": lambda path: TextLoader(path, encoding="utf-8")  # txtファイルのサポートを追加
}
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    4. 回答は、読みやすさを考慮し、100文字から200文字程度の要約として簡潔にまとめてください。
    5. マークダウン記法で回答する際にhタグの見出しを使う場合、最も大きい見出しをh3としてください。
    6. 複雑な項目であっても、長くなりすぎないように要点を抽出して回答してください。
...
NO_DOC_MATCH_MESSAGE = """
    ...
    入力内容を変更してください。
"""
CONVERSATION_LOG_ERROR_MESSAGE = "会話履歴の取得に失敗しました。"
GET_LLM_RESPONSE_ERROR_MESSAGE = "回答の生成に失敗しました。"
DISP_ANSWER_ERROR_MESSAGE = "画面表示の処理に失敗しました。"
